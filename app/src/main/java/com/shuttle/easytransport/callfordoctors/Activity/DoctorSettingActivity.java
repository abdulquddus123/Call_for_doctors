...
public class DoctorSettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseReference= FirebaseDatabase.getInstance().getReference().child("doctor").child(uid);
        ...
        mDatabaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(!image.equals("default"))
                    ...
                    //----OFFLINE FEATURE-----
                    Picasso.with(DoctorSettingActivity.this).load(image).networkPolicy(NetworkPolicy.OFFLINE).
                        ...
                        @Override
                        public void onError() {
                            Picasso.with(DoctorSettingActivity.this).load(image).placeholder(R.drawable.user_img).into(mCircleImageView);
                        }
                    });
    ...
    public void buttonIsClicked(View view){
        ...
        switch(view.getId()){
            ...
            case R.id.buttonChangeStatus:
                Intent intent =new Intent(DoctorSettingActivity.this,DoctorStatusActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == GALLERY_PICK && resultCode == RESULT_OK){
            ...
            CropImage.activity(sourceUri).
                    ...
                    start(DoctorSettingActivity.this);
                                        ...
                                        mDatabaseReference.updateChildren(update_HashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                ...
                                                if(task.isSuccessful()){
                                                    ...
                                                    Toast.makeText(DoctorSettingActivity.this, "Uploaded Successfuly...", Toast.LENGTH_SHORT).show();
