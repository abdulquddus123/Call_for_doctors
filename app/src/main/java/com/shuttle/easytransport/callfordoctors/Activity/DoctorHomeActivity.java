...
import com.shuttle.easytransport.callfordoctors.Fragment.DoctorPagerAdapter;
...
public class DoctorHomeActivity extends AppCompatActivity {
    ...
    DoctorPagerAdapter mFragmentPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mviewPager=(ViewPager)findViewById(R.id.doctorViewPager);

        //---ADDING ADAPTER FOR FRAGMENTS IN VIEW PAGER----
        mFragmentPagerAdapter=new DoctorPagerAdapter(getSupportFragmentManager());
    ...
    public void onBackPressed() {
        ...
        builder.setPositiveButton("Ok",new DoctorHomeActivity.MyListener());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.main_menu_doctor,menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId()==R.id.settings){
            Intent intent=new Intent(DoctorHomeActivity.this,DoctorSettingActivity.class);
            startActivity(intent);
        }
        if(item.getItemId()==R.id.allUsers){
            Intent intent=new Intent(DoctorHomeActivity.this,AllPatientActivity.class);
            startActivity(intent);
        }

        //---LOGGING OUT AND ADDING TIME_STAMP----
        if(item.getItemId()==R.id.logout){
            Intent intent=new Intent(DoctorHomeActivity.this,LoginViewActivity.class);
            startActivity(intent);
...
//                    }
//                    else{
//                        Toast.makeText(DoctorHomeActivity.this, "Try again..", Toast.LENGTH_SHORT).show();
//                    }
//                }
//            });
        }
    ...
    private void startfn(){
        Intent intent = new Intent(DoctorHomeActivity.this,DortorLogin.class);
        startActivity(intent);
        finish();
    }
}
