...
import com.shuttle.easytransport.callfordoctors.Model.Conv;
...
public class DoctorChatsFragment extends Fragment {
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Conv,ChatsFragment.ConvViewHolder> friendsConvAdapter=new FirebaseRecyclerAdapter<Conv, ChatsFragment.ConvViewHolder>(
            ...
            @Override
            protected void populateViewHolder(final ChatsFragment.ConvViewHolder convViewHolder,
