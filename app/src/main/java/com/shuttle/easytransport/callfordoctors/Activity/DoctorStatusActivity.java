...
public class DoctorStatusActivity extends AppCompatActivity {
    ...
    public void buttonIsClicked(View view){
        ...
        if(TextUtils.isEmpty(status)){
            Toast.makeText(DoctorStatusActivity.this, "Please write something...", Toast.LENGTH_SHORT).show();
            return ;
        }
        ...
        mDatabaseReference.child("status").setValue(status).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if(task.isSuccessful()){
                    Toast.makeText(DoctorStatusActivity.this, "Status Updated Successfully", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(DoctorStatusActivity.this, "Status cannot be updated", Toast.LENGTH_SHORT).show();
                }
            }
        });
