...
import com.shuttle.easytransport.callfordoctors.Activity.ChatActivity;
import com.shuttle.easytransport.callfordoctors.Activity.ProfileActivity;
import com.shuttle.easytransport.callfordoctors.Model.Friends;
 ...
 */
public class DoctorFriendsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //---USERS DATA
        mUsersDatabase=FirebaseDatabase.getInstance().getReference().child("patient");
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Friends,FriendsFragment.FriendsViewHolder> friendsRecycleAdapter=new FirebaseRecyclerAdapter<Friends, FriendsFragment.FriendsViewHolder>(
                Friends.class,
            ...
            @Override
            protected void populateViewHolder(final FriendsFragment.FriendsViewHolder friendViewHolder,
