...
public class DortorRegistration extends AppCompatActivity {
    FirebaseAuth mauth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dortor_registration);
        ...
        progressDialog=new ProgressDialog(DortorRegistration.this);
    ...
    public void buttonIsClicked(View view){
        ...
        if(view.getId()==R.id.button3){
            ...
            if(displayname.equals("")){
                Toast.makeText(DortorRegistration.this, "Please Fill the name", Toast.LENGTH_SHORT).show();
                return;
            }

            if(email.equals("")){

                Toast.makeText(DortorRegistration.this, "Please Fill the email", Toast.LENGTH_SHORT).show();
                return ;
            }

            if(password.length()<6){
                Toast.makeText(DortorRegistration.this, "Password is too short", Toast.LENGTH_SHORT).show();
                return;
            }
        ...
        mauth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(this,new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if(task.isSuccessful()){
                    ...
                    userMap.put("status","Skin Specialist");
                    userMap.put("image","default");
                    userMap.put("thumb_image","default");
                    userMap.put("online","true");

                    doctorDatabase.child(uid).setValue(userMap);
                    ...
                    mDatabase.child(uid).setValue(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task1) {
                            if(task1.isSuccessful()){
                                ...
                                Intent intent=new Intent(DortorRegistration.this,DoctorHomeActivity.class);
                                ...
                                Toast.makeText(DortorRegistration.this, "YOUR NAME IS NOT REGISTERED... MAKE NEW ACCOUNT-- ", Toast.LENGTH_SHORT).show();
