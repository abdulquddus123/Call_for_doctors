...
public class DortorLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dortor_login);
        ...
        progressDialog=new ProgressDialog(DortorLogin.this);
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder=new AlertDialog.Builder(DortorLogin.this);
        builder.setMessage("Really Exit ??");
        builder.setTitle("Exit");
        builder.setCancelable(false);
        builder.setPositiveButton("Ok",new DortorLogin.MyListener());
        ...
        switch(view.getId()){
            ...
            case R.id.buttonSign:
                ...
                if(TextUtils.isEmpty(email)||TextUtils.isEmpty(password)){
                    Toast.makeText(DortorLogin.this, "Please Fill all blocks", Toast.LENGTH_SHORT).show();
                    return ;
                }
            ...
            case R.id.buttonRegister:
                ...
                Intent intent=new Intent(DortorLogin.this,PatientRegistration.class);
...
//                            Intent intent=new Intent(DortorLogin.this,DoctorHomeActivity.class);
//                            startActivity(intent);
//                            finish();
...
//                            addValue.put("online","true");
                            ...
                            mDatabaseReference.child(user_id).updateChildren(addValue, new DatabaseReference.CompletionListener(){
                                ...
                                public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                                    ...
                                    if(databaseError==null){
                                        ...
                                        Toast.makeText(DortorLogin.this, databaseError.toString()  , Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(DortorLogin.this, "Wrong Email and password" +
