...
public class PatientProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(user_id==null){
            Intent intent = new Intent(PatientProfile.this,HomeActivity.class);
...
//        Log.e("user_id is",user_id);
        ...
        mProfileImage = (ImageView)findViewById(R.id.pProfileUserImage);
        mProfileName = (TextView)findViewById(R.id.pProfileUserName);
        mProfileStatus=(TextView)findViewById(R.id.pProfileUserStatus);
        mprofileFriendCount=(TextView)findViewById(R.id.pProfileUserFriends);
        mProfileSendReqButton=(Button)findViewById(R.id.pProfileSendReqButton);
        mProfileDeclineReqButton=(Button)findViewById(R.id.pProfileDeclineReqButton);


        callIcon=(Button) findViewById(R.id.call_now);
        ...
        callIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                callIntent.setData(Uri.parse("mobile_number"));
                callIntent.setData(Uri.parse("tel:"+mobile_number));


                if (ActivityCompat.checkSelfPermission(PatientProfile.this,
        ...
        mDatabaseReference=FirebaseDatabase.getInstance().getReference().child("patient").child(user_id);
        ...
        //----fOR SETTING ONLINE---
        getmDatabaseReference = FirebaseDatabase.getInstance().getReference().child("user").child(mFirebaseUser.getUid());
        ...
        mDatabaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(PatientProfile.this).load(display_image).placeholder(R.drawable.user_img).into(mProfileImage);
                ...
                mFriendDatabase.child(user_id).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        mfriendReqReference.child(mFirebaseUser.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            @Override
                            public void onCancelled(DatabaseError databaseError) {
                                Toast.makeText(PatientProfile.this, "Error fetching Friend request data", Toast.LENGTH_SHORT).show();
                            }
                        });
        ...
        mProfileSendReqButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(mUserId.equals(user_id)){
                    Toast.makeText(PatientProfile.this, "Cannot send request to your own", Toast.LENGTH_SHORT).show();
                    return ;
                }
                    ...
                    mRootReference.updateChildren(requestMap, new DatabaseReference.CompletionListener() {
                        ...
                        public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                            if(databaseError==null){
                                ...
                                Toast.makeText(PatientProfile.this, "Friend Request sent successfully", Toast.LENGTH_SHORT).show();
                                ...
                                mProfileSendReqButton.setEnabled(true);
                                Toast.makeText(PatientProfile.this, "Some error in sending friend Request", Toast.LENGTH_SHORT).show();
                            }
                    ...
                    mRootReference.updateChildren(valueMap, new DatabaseReference.CompletionListener() {
                        ...
                        public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                            if(databaseError == null){
                                ...
                                mProfileSendReqButton.setEnabled(true);
                                Toast.makeText(PatientProfile.this, "Friend Request Cancelled Successfully...", Toast.LENGTH_SHORT).show();
                            }
                            else{

                                mProfileSendReqButton.setEnabled(true);
                                Toast.makeText(PatientProfile.this, "Cannot cancel friend request...", Toast.LENGTH_SHORT).show();
                    ...
                    mRootReference.updateChildren(friendMap, new DatabaseReference.CompletionListener() {
                        ...
                        public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                            ...
                            if(databaseError==null){
                                ...
                                mProfileSendReqButton.setEnabled(true);
                                Toast.makeText(PatientProfile.this, "Error is " +databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                    ...
                    mRootReference.updateChildren(valueMap, new DatabaseReference.CompletionListener() {
                        ...
                        public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                            if(databaseError == null){
                                ...
                                mProfileSendReqButton.setText("Send Friend Request");
                                mProfileSendReqButton.setEnabled(true);
                                Toast.makeText(PatientProfile.this, "Successfully Unfriended...", Toast.LENGTH_SHORT).show();
                            }
                            else{
                                mProfileSendReqButton.setEnabled(true);
                                Toast.makeText(PatientProfile.this, "Cannot Unfriend..Contact Kshitiz..", Toast.LENGTH_SHORT).show();
                ...
                mRootReference.updateChildren(valueMap, new DatabaseReference.CompletionListener() {
                    ...
                    public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                        if(databaseError == null){
                            ...
                            mProfileSendReqButton.setText("Send Friend Request");
                            mProfileSendReqButton.setEnabled(true);
                            Toast.makeText(PatientProfile.this, "Friend Request Declined Successfully...", Toast.LENGTH_SHORT).show();
                            ...
                            mProfileSendReqButton.setEnabled(true);
                            Toast.makeText(PatientProfile.this, "Cannot decline friend request...", Toast.LENGTH_SHORT).show();
