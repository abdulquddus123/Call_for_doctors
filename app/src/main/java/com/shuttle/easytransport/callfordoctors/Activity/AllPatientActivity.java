...
import com.shuttle.easytransport.callfordoctors.Model.Users;
import com.shuttle.easytransport.callfordoctors.R;
import com.squareup.picasso.Picasso;

import de.hdodenhof.circleimageview.CircleImageView;

public class AllPatientActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUsersDatabaseReference= FirebaseDatabase.getInstance().getReference().child("patient");
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Users , UsersActivity.UserViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Users, UsersActivity.UserViewHolder>(
                Users.class,
            ...
            @Override
            protected void populateViewHolder(UsersActivity.UserViewHolder viewHolder, Users users, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent profileIntent=new Intent(AllPatientActivity.this,PatientProfile.class);
